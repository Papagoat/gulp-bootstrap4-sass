...
let bootstrap = config.paths.node_modules + 'bootstrap-scss/bootstrap.scss';
let boostrap_dir = config.paths.node_modules + 'bootstrap-scss/';
...
function buildTasks(done) {
  return series(clean, bootstrapCompile, sassCompile, jsCompile, html, images, injectFiles);
  done();
}
...
*/
exports.build = series(clean, bootstrapCompile, sassCompile, jsCompile, html, images, injectFiles);
